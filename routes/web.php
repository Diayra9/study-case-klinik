...
// LANDING PAGE & OTHER
Route::get('/', function () { return view('homepage.page.index'); });
Route::get('/about-us', function () { return view('homepage.page.about-us'); });
Route::get('/promo', function () { return view('homepage.page.promo'); });
