...
@include('header')
    ...
    <div class="container-6">
        ...
        <img class="line-2" src="{{ asset('../public/assets/vectors/line_2_x2.svg') }}" />
        <div class="line-1"></div><br><br>

        <div class="locations">
            <div class="location-card">
                <h2 class="location-name eternelle-surabaya">Eternelle Surabaya</h2>
                <img src="{{ asset('../public/assets/images/surabaya.jpg') }}" alt="Location 1" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
                    <p class="address">Jl. Siwalankerto Permai 10</p>
                </div>
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-phone-30.png') }}" alt="Phone Icon" class="icon">
            ...
            <div class="location-card">
                ...
                <img src="{{ asset('../public/assets/images/surakarta.jpg') }}" alt="Location 2" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
            ...
            <div class="location-card">
                ...
                <img src="{{ asset('../public/assets/images/sidoarjo.jpg') }}" alt="Location 3" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
            ...
            <div class="location-card">
                ...
                <img src="{{ asset('../public/assets/images/bandung.jpg') }}" alt="Location 4" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
            ...
            <div class="location-card">
                ...
                <img src="{{ asset('../public/assets/images/jakarta.jpeg') }}" alt="Location 5" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
            ...
            <div class="location-card">
                ...
                <img src="{{ asset('../public/assets/images/jogja.jpg') }}" alt="Location 6" class="location-card-img">
                <div class="location-info">
                    <img src="{{ asset('../public/assets/images/icons8-location-30.png') }}" alt="Location Icon" class="icon">
